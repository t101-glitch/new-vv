...
const StudentDashboard: React.FC = () => {
  ...
  const handleStartSession = () => {
    ...
    // Simulate premium gate
    if (selectedMode === SessionMode.FULL_SOLUTION) {
       // Ideally check user entitlement here. For demo, we just proceed but "mock" the value.
    }
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className={`w-full p-6 rounded-2xl border-2 text-left transition-all relative overflow-hidden group ${
              selectedMode === SessionMode.INTERACTIVE 
